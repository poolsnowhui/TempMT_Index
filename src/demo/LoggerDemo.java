...
public class LoggerDemo {
	public static void main(String[] args) {
		...
		// String mysql = "select * from student1000k where vts_timeDB <=
		// \"2009-05-19 09:16:43\" and vte_timeDB >= \"2014-05-19 16:28:43\"" ;
		// System.out.println(mysql);
		// try {
		// List<Object[]> executeQuery =
		// DAOFactory.getInstance().executeQuery(mysql);
		// List<Object[]> executeQuery2 =
		// DAOFactory.getInstance().executeQuery(mysql);
		// List<Object[]> executeQuery3 =
		// DAOFactory.getInstance().executeQuery(mysql);
		// List<Object[]> executeQuery4 =
		// DAOFactory.getInstance().executeQuery(mysql);
